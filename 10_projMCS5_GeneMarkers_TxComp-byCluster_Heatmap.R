...
C1ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C1"]

C2ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C2"]

C3ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C3"]

C4ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C4"]

C5ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C5"]

C6ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C6"]

C7ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C7"]

C8ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C8"]

C9ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C9"]

C10ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C10"]

C11ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C11"]

C12ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C12"]

C13ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C13"]

C14ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C14"]

C15ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C15"]

C16ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C16"]

C17ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C17"]

C18ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C18"]

C19ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C19"]

C20ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C20"]

C21ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C21"]

C22ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C22"]

C23ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C23"]

C24ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C24"]

C25ArchRSubset <- projMCS5[projMCS5$Clusters %in% "C25"]
...
write.csv(markerList, file = "C1_markerList_2024-04-08.csv", row.names = FALSE)
