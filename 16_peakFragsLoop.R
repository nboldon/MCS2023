...
cellData <- getCellColData(ArchRProj = projMCS7)
...
for (sample in sampleNames) {
  ...
  peakMatrix_list[[sample]] <- peakMatrix
}

# After the loop, peakMatrix_list contains peak matrices for all samples
