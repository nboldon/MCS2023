...
mat<-read.csv("./C1_Combined_GeneMarkers_Comps_2024-11-07.csv",header=TRUE,row.names=1,
              check.names=FALSE)
...
## Makes a heatmap
pdf(file="C1_Combined_GeneMarkers_Comps_Heatmap_2024-11-07.pdf", width=15, height=80)
...
for (cluster in 1:25) {
  ...
  input_file <- sprintf("C%d_Combined_GeneMarkers_Comps_2024-11-07.csv", cluster)
  ...
  if (file.exists(input_file)) {
    ...
    pdf_file <- sprintf("C%d_Combined_GeneMarkers_Comps_Heatmap_2024-11-07.pdf", cluster)
...
for (cluster in 1:25) {
  ...
  if (file.exists(input_file)) {
    ...
    pdf_file <- sprintf("C%d_Combined_GeneMarkers_Comps_Heatmap_NA-removed_2024-11-07.pdf", cluster)
...
for (cell_type in cell_types) {
  ...
  input_file <- sprintf("%s_Combined_GeneMarkers_Comps_2024-12-02.csv", cell_type)
  ...
  if (file.exists(input_file)) {
    ...
    pdf_file <- sprintf("%s_Combined_GeneMarkers_Comps_Heatmap_NA-removed_2024-12-02.pdf", cell_type)
