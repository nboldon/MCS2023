...
## The following cutoffs did not yield many genes:
...
write.csv(geneMarkerList, file = "GenotypeTxComp_FDR-0-1_Log2FC-0-5_2024-06-28.csv", row.names = FALSE)
...
# Write markerList to a CSV file: 
write.csv(geneMarkerList, file = "GenotypeCompByCluster_FDR-0-1_Log2FC-0-5_2024-06-28.csv", row.names = FALSE)
